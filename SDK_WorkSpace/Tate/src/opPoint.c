...
void addAfineFp2 (PointFp2 P1, PointFp2 P2, PointFp2 *T, unsigned long lambda[2][9]){
    if (isInfinityFp2(P1)) {
        affPointFp2(P2, T);
    }
...
void addAfineFp (PointFp P1, PointFp P2, PointFp *T, unsigned long lambda[9]){
    if (P1.isInfinity==1) {
        affPointFp(P2, T);
    }
        ...
        PointFp E;
        unsigned long lam[9],P1x2[9],denom[9];
