...
void mulFp6 (elemFp6 a, elemFp6 b, elemFp6 *res){
    ...
    ///***************** 4 *****************
    addFp2(b.v1,b.v2,tmp0);
    addFp2(a.v1,a.v2,tmp1); // on peut remplacer tmp1 par (*res).v0
    karatsubaFp2(tmp1,tmp0,tmp1);
    subFp2(tmp1,t1,tmp1);
    subFp2(tmp1,t2,tmp1);
    mulXFp2(tmp1,tmp1);
    ...
    ///***************** 5 *****************
    addFp2(b.v0,b.v1,tmp0);
    addFp2(a.v0,a.v1,(*res).v1);
    karatsubaFp2((*res).v1,tmp0,(*res).v1);
    subFp2((*res).v1,t0,(*res).v1);
    subFp2((*res).v1,t1,(*res).v1);
    mulXFp2(t2,tmp0);
    addFp2((*res).v1,tmp0,(*res).v1);

    ///***************** 6 *****************
    addFp2(b.v0,b.v2,tmp0);
    addFp2(a.v0,a.v2,(*res).v2);
    karatsubaFp2((*res).v2,tmp0,(*res).v2);
...
/*
// Enter in Montgomery field Fp6
void transfMongFp6 (elemFp6 *P){
    transfMongPol((*P).v0,2);
    transfMongPol((*P).v1,2);
    transfMongPol((*P).v2,2);

}

// Get out Montgomery field Fp6
void invTransMongFp6(elemFp6 l, elemFp6 *n){
    invTransMongPol(l.v0,(*n).v0,2);
    invTransMongPol(l.v1,(*n).v1,2);
    invTransMongPol(l.v2,(*n).v2,2);
