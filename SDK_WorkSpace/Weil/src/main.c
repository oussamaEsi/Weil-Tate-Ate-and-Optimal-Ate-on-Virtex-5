...
int main()
{
                ...
                ///*********************************************************///
///***************************************************************************************************************************///
///!!!!!!!!!!!!!!!!!!!!!!!!!! WARINIIIIIIINNNNNGGG si p ou R CHANGE les valeurs qui suivent doivent CANGER !!!!!!!!!!!!!!!!!!!!!!!!!!!/////
///***********************************************************************************************************************///

two[0]=0x647db4d5; two[1]=0x2b1b84af; two[2]=0x4085cf8b; two[3]=0xe7e1c2e9; two[4]=0x95b02b6d; two[5]=0x2d91dbd7; two[6]=0x1b1a1984; two[7]=0x87c8b381;
two[8]=0;

three[0]=0x2a85413e; three[1]=0xcc2acd5d; three[2]=0x8ae45219; three[3]=0x3f21cd7f; three[4]=0xf9671f77; three[5]=0xbc5192ce; three[6]=0xa309bb7e;
three[7]=0x52ae817b; three[8]=0;

four[0]=0xf08ccda7; four[1]=0x6d3a160a; four[2]=0xd542d4a8; four[3]=0x9661d815; four[4]=0x5d1e1380; four[5]=0x4b1149c6; four[6]=0x2af95d79;
four[7]=0x1d944f76; four[8]=0;

eight[0]=0xe1199b4e; eight[1]=0xda742c15; eight[2]=0xaa85a950; eight[3]=0x2cc3b02b; eight[4]=0xba3c2701; eight[5]=0x9622938c; eight[6]=0x55f2baf2;
eight[7]=0x3b289eec; eight[8]=0;

onetwo[0]=0xcf3b1436; onetwo[1]=0x45061e00; onetwo[2]=0x7b13a67e; onetwo[3]=0x4850dc29; onetwo[4]=0x18fc9bb2; onetwo[5]=0xcf691270; onetwo[6]=0x49953bc4;
onetwo[7]=0x5e7172c3; onetwo[8]=0;

onethree[0]=0xdf7cb824; onethree[1]=0x83596955; onethree[2]=0x520d19a9; onethree[3]=0xdae092c6; onethree[4]=0xbb531276; onethree[5]=0x8a460c4a;
onethree[6]=0x310e27d8; onethree[7]=0x3ef64c82; onethree[8]=0;

onesix[0]=0xefbe5c12; onesix[1]=0xc1acb4aa; onesix[2]=0x29068cd4; onesix[3]=0x6d704963; onesix[4]=0x5da9893b; onesix[5]=0x45230625; onesix[6]=0x188713ec;
onesix[7]=0x1f7b2641; onesix[8]=0;

///*********************************************************************************************************************************///
///!!!!!!!!!!!!!!!!!!!!!!!!!! WARINIIIIIIINNNNNGGG si p ou R CHANGE les valeurs qui suivent doivent CHANGER !!!!!!!!!!!!!!!!!!!!!!!!!!!/////
///***********************************************************************************************************************///
                          ///*******************************************************///

  /*unsigned long k=12,ext=12,tRes=calculLenMulModPol(k,ext),tRes2=2*k-1;
  unsigned long (*Resultat)[9]=malloc(sizeof(unsigned long[tRes][9]));    initNul2D(Resultat,tRes,9);
  unsigned long (*Resultat2)[9]=malloc(sizeof(unsigned long[tRes2][9]));  initNul2D(Resultat,tRes2,9);*/
